...
<?php
	...
	$outsourcing = json_decode($_POST['outsourcingPhp']);
...
$body .= "<h1>Получен заказ на услуги ИТ-аутсорсинга</h1></br>";

foreach ($outsourcing as $key => $value) {
	if($key=='undefined')
...
//$mail->addReplyTo('kaztester@gmail.com', 'kaztester@gmail.com');


//Set the subject line


$mail->Subject = 'Получен заказ на услуги ИТ-аутсорсинга';
